...
export const HARDCODED_CONTENT: Content[] = [
  {
    id: "tt33043892",
...
export function getHardcodedContent(): Content[] {
  return HARDCODED_CONTENT;
}

export function getHardcodedContentById(id: string): Content | undefined {
  return HARDCODED_CONTENT.find(c => c.id === id);
}

export function getHardcodedMovies(): Content[] {
  return HARDCODED_CONTENT.filter(c => c.type === 'movie');
}

export function getHardcodedSeries(): Content[] {
  return HARDCODED_CONTENT.filter(c => c.type === 'series');
}

export function getHardcodedFeatured(): Content[] {
  return HARDCODED_CONTENT.filter(c => c.featured);
}
